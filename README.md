...
[11. 2048](https://dinomoon.github.io/ZeroCho_JS/11.%202048/mine/index.html)
...
6. 자스스톤.. 화면과 데이터를 일치시키는 것이 어렵다.. -> 리액트, 뷰, 앵귤러를 사용하는 이유(자바스크립트로는 하나가 바뀌었을 때 그 놈만 따로 처리하는 게 굉장히 귀찮은 작업인데 그것을 쉽게 해줌)
7. 공격을 했을 때, 상대방 카드의 체력을 감소시켜야하는 데, 어떤 카드가 공격받았는지 알기 귀찮으니까 공격받은 카드의 데이터에 변화를 주고 싹 다 다시 그린다.(비효율적이더라도 타협을 할 줄 알아야한다.)
8. 2048 논리 진짜 엄청 헷갈린다..
